package com.aulas.mvc.controlllers;
...
import com.aulas.mvc.repositorios.ContatoRepositorio;

@Controller
@RequestMapping("/")
public class ContatoController {
	@Autowired
	ContatoRepositorio repositoryContato;
	...
	public String deletar(@PathVariable("idContato") int id) {

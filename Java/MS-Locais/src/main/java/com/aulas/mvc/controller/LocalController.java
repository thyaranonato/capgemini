...
import com.aulas.mvc.service.LocalService;
...
public class LocalController {
	...
	public ResponseEntity<String> reservar(@PathVariable("idlocal") Long idlocal, @PathVariable("reservar") boolean reservar) {
